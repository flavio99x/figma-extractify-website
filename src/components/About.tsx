...
const features = [
	{
		icon: Palette,
		title: "Design Tokens",
		description: "Extracts your colors, spacing, and variables straight from Figma into CSS custom properties.",
	},
	{
		icon: Type,
		title: "Typography System",
		description: "Pulls your font families, sizes, weights, and line heights into a scalable type scale.",
	},
	{
		icon: LayoutGrid,
		title: "Component Builder",
		description: "Run a single command and get a fully typed, props-driven React component from any Figma frame.",
	},
	{
		icon: Eye,
		title: "Visual Review",
		description: "Playwright screenshots your component and pixel-diffs it against the Figma design. 95%+ to pass.",
	},
	{
		icon: Accessibility,
		title: "Accessibility Audit",
		description: "axe-core scans every component for WCAG violations. Zero critical issues allowed.",
	},
	{
		icon: Link2,
		title: "Code Connect",
		description: "Links finished components back to their Figma node so your team sees real code in Dev Mode.",
	},
]
